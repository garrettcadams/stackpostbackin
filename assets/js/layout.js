function Layout(){
    var self= this;
    var chart_color = ["rgba(22,211,154,0.7)", "rgba(255,117,136, 0.7)", "rgba(255,168,125,0.7)", "rgba(12,194,126,0.7)", "rgba(28,188,216,0.7)", "rgba(64,78,103,0.7)"];
    this.init= function(){
    	//Callback
    	self.sidebar();
    	self.optionLayout();
    ...
    this.lineChart = function(element, label, data, name){
